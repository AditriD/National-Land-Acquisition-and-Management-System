...
const RESOURCES = [
  { title: 'RFCTLARR Act, 2013', desc: 'The governing legislation for fair compensation and transparency in land acquisition.', href: '/resources/rfctlarr-act' },
  { title: 'Land Acquisition Guidelines', desc: 'Procedural guidance for requiring bodies and implementing agencies.', href: '/resources/land-acquisition-guidelines' },
  { title: 'Government Notifications', desc: 'Official notifications relevant to ongoing acquisitions.', href: '/resources/government-notifications' },
  { title: 'User Manuals', desc: 'Step-by-step guides for each role on the platform.', href: '/resources/user-manuals' },
  { title: 'FAQs', desc: 'Answers to common questions from citizens and officials.', href: '/resources/faqs' },
  { title: 'Contact & Support', desc: 'Reach the platform support team for assistance.', href: '/resources/contact-support' },
]
      ...
      <section id="resources" className="bg-slate-50 py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {RESOURCES.map((r) => (
              <Link key={r.title} href={r.href} className="group bg-white rounded-xl border border-slate-200 p-5 hover:border-gold hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5">
                <h3 className="font-semibold text-navy-dark text-sm mb-1.5 group-hover:text-gold transition-colors">{r.title}</h3>
