...
export default function NewParcelPage() {
  ...
  // DISTRICT users: district field is locked to their own district
  ...
  return (
    <Card className="p-8 max-w-lg mx-auto mt-10">
      <h1 className="text-xl font-semibold mb-6">New Land Parcel</h1>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {isDistrictUser ? (
          <Input placeholder="District" value={effectiveDistrict} disabled />
        ) : (
          <Input
